...
public class Pregunta3 extends AppCompatActivity implements Spinner.OnItemSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        siguiente=(Button)findViewById(R.id.buttonSiguiente3);
        respuestas=(Spinner)findViewById(R.id.spinner3);
    ...
    public void onClick(View v) {
        ...
        intent.putExtra("resp3", respuestaFinal);
